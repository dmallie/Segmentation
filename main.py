...
from UNET_architecture_2 import UNet_2
...
TRAIN_PATH = "/media/Linux/Mallie_Dagmawi/PyTorch/data/Dataset/UNet_Refined/Train/image_enhanced/"
VAL_PATH = "/media/Linux/Mallie_Dagmawi/PyTorch/data/Dataset/UNet_Refined/Val/image_enhanced/"
...
def main():
    ...
    model = UNet_2(in_channels = 1,  out_channels = 1).to(DEVICE)
